...
export default function CatalogPush({ orgId }: CatalogPushProps) {
  ...
  const runPreview = async () => {
    ...
    try {
      ...
      // ⚡ Bolt Optimization:
      // Executing store fetch operations in parallel instead of sequentially.
      // This reduces total network wait time significantly when selecting multiple stores.
  ...
  const runPush = async () => {
    ...
    try {
      ...
      // ⚡ Bolt Optimization:
      // Executing store fetch and push operations in parallel instead of sequentially.
