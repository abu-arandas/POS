...
| ----------------------- | --------------------------------------------------: | -------------------------------------- |
| Unit test files         |                                          61 passing | `npm test`                             |
| Unit tests              |                                         527 passing | `npm test`                             |
...
| Initial JavaScript      |              433,690 raw bytes / 135,819 gzip bytes | `npm run build` + `npm run perf:check` |
...
| Instrumented functions  |                                              47.03% | `npm run test:coverage`                |
| Instrumented lines      |                                              58.19% | `npm run test:coverage`                |
